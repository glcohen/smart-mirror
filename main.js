...
config = require(__dirname + "/node_modules/vocal/lib/vocal.js");
...
function createWindow () {
  ...
  var browserWindowOptions = {width: 800, height: 600, icon: 'favicon.ico' , kiosk:true, autoHideMenuBar:false, darkTheme:true};
  if (externalDisplay) {
